...
class ReqAttendanceCard extends StatelessWidget {
  const ReqAttendanceCard({
    super.key,
    required this.jenis,
    required this.time,
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    BaseText(
                      text: statusApprove == 'ReqAttendance'
                          ? 'Waiting'
                    ...
                    Icon(
                      statusApprove == 'ReqAttendance'
                          ? MingCute.time_line
                          : statusApprove == 'approve'
                              ? MingCute.check_circle_line
                              : MingCute.close_circle_line,
                      size: 30,
                      color: statusApprove == 'ReqAttendance'
